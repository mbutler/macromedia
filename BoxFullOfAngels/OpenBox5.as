package
{
	...
	public class OpenBox5 extends Sprite
	{
		var icon1:NBIcon = new NBIcon("B5N1");
		var icon2:NBIcon = new NBIcon("B5N2");
		var icon3:NBIcon = new NBIcon("B5N3");
		var icon4:NBIcon = new NBIcon("B5N4");
		var exit:RedButton = new RedButton();
		
		public function OpenBox5()
		{
			x = 300; y = 100;
